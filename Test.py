...
# If no API key is provided, show a warning, but the UI remains accessible
if not user_api_key:
    st.warning("Please provide your OpenAI API key to start using AI features.")
else:
        ...
        try:
            ...
            if ai_response:
                try:
                    ...
                    # Now that we've made the prompt clear that all steps must be returned, 
                    # we directly process the response.
